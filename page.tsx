...
const dashboardItems = [
  ...
  { icon: Users2, title: "শিক্ষক তালিকা", color: "from-blue-400 to-indigo-500", link: "/teachers" },
          ...
          {dashboardItems.map((item, index) => (
            ...
            >
              <Link href={item.link} passHref>
                <motion.div
                  className={`w-full h-full bg-gradient-to-br ${item.color} text-white rounded-xl overflow-hidden shadow-lg transition-all duration-300 transform hover:shadow-2xl cursor-pointer`}
                >
                  <div className="p-6 flex flex-col items-center justify-center text-center space-y-4">
                    ...
                    <motion.div 
                      className="p-3 rounded-full bg-white/90 transition-colors duration-300"
